...
export const projects: Project[] = [
  {
    ...
    summary:
      "Cloud Run・Pub/Sub・Firestore・ADKは実務初採用でしたが、個人開発でも並行してGCP環境を構築し理解を深めながらキャッチアップ。クリーンアーキテクチャとSRPを適用し、コードレビューを通じて保守性の高いコードベース維持に貢献しました。GASの実行時間制限に対しては自ら手法を調査・特定し、UXを改善しました。",
  },
  {
    ...
    summary:
      "Python・Azure構築ともに実務初採用でしたが、独学の知見を活かしスムーズにキャッチアップ。数十万件規模でも耐えるETLのスワップ方式を提案・実装し、フロントエンドのUXも改善しました。",
  },
  {
    ...
    summary:
      "2週間で帳票11本を作成し、効率的なやり方をチームに提案。複数帳票種別で共通する処理を多態性を意識して共通化し、量産時の工数削減に貢献しました。",
  },
  {
    ...
    summary:
      "APIファーストでの設計を中心となって推進し、他アプリからも利用可能な設計を実現。ツリー構造の申請カテゴリUIを提案しUXを改善。常に共通化を意識し保守性の高い製品開発に貢献しました。",
  },
  {
    ...
    summary:
      "オフショア/インフラチームとの調整をリードしながら複数システムの刷新を推進。要件定義から保守運用までを一気通貫で担当し、4拠点への導入・サポートも実施しました。",
  },
  {
    ...
    summary:
      "現行仕様の読み解きから新システムへの仕様策定までを主導し、若手メンバーの育成や画面チームの進捗管理も担当しました。",
  },
];
