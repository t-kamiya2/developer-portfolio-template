...
export const projects = [
  {
    ...
    summary: "クラウドサービスの実務初採用が多い環境でしたが、個人開発でも並行して環境を構築し理解を深めながらキャッチアップ。クリーンアーキテクチャとSRPを適用し、コードレビューを通じて保守性の高いコードベース維持に貢献しました。パフォーマンス制約に対しては自ら手法を調査・特定し、UXを改善しました。"
  },
  {
    period: "2023年 〜 2024年",
    title: "業務支援ツールの開発",
    ...
    summary: "言語・クラウド基盤ともに実務初採用でしたが、独学の知見を活かしスムーズにキャッチアップ。大規模データでも耐えるETLの方式を提案・実装し、フロントエンドのUXも改善しました。"
  },
  {
    period: "2022年 〜 2023年",
    ...
    summary: "短期間で複数帳票を作成し、効率的なやり方をチームに提案。複数帳票種別で共通する処理を多態性を意識して共通化し、量産時の工数削減に貢献しました。"
  },
  {
    period: "2019年 〜 2022年",
    ...
    summary: "APIファーストでの設計を中心となって推進し、他アプリからも利用可能な設計を実現。ツリー構造のUIを提案しUXを改善。常に共通化を意識し保守性の高い製品開発に貢献しました。"
  },
  {
    period: "2016年 〜 2019年",
    ...
    summary: "関係チームとの調整をリードしながら複数システムの刷新を推進。要件定義から保守運用までを一気通貫で担当し、複数拠点への導入・サポートも実施しました。"
  },
  {
    period: "2013年 〜 2016年",
    ...
    summary: "現行仕様の読み解きから新システムへの仕様策定までを主導し、若手メンバーの育成や進捗管理も担当しました。"
  }
];
